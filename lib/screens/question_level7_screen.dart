...
class QuestionLevel7Screen extends StatefulWidget {

  @override
  State<QuestionLevel7Screen> createState() => _QuestionLevel7ScreenState();
}

class _QuestionLevel7ScreenState extends State<QuestionLevel7Screen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: PageView.builder(
          ...
          itemCount: dataModel!.level7!.length,
            ...
            return Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(dataModel!.level7![index].question!,style: TextStyle(color: Colors.white,fontSize: 18),),
                  SizedBox(
                    height: 10,
                  ),
                  Container(
                    ...
                    child: dataModel!.level7![index].img,
                  ),
                  SizedBox(
                    height: 10,
                  ),
                    ...
                    ElevatedButton(
                      style: ElevatedButton.styleFrom(
                          ...
                          shape: RoundedRectangleBorder(
                              ...
                              side: BorderSide(
                                  color: isPressed?
                                  dataModel!.level7![index].answer![i] ? isTrue : isWrong : backGroundColor,
                                  width:2,
                      ...
                      onPressed: () {
                        if(dataModel!.level7![index].answer![i]  && isPressed == false){
                          setState(() {
                            score+=10;
                          });
                        }
                      ...
                      child:Row(
                        children: [
                          ...
                          Text(dataModel!.level7![index].choise![i],style: TextStyle(color:Colors.white)),
                        ],
                      ),
                    ),
                  Row(
                    ...
                    children: [
                      ...
                      ElevatedButton(
                          style: ElevatedButton.styleFrom(
                              ...
                              backgroundColor:
                              index+1 == dataModel!.level7!.length ?
                          ...
                          onPressed: () {
                            ...
                            Navigator.push(
                              context,
                              MaterialPageRoute(builder: (context)=>ResultScreen(finalScore: score,level: "level7",)),
                            ):
                            controller!.nextPage(
                                duration: Duration(seconds: 1),
                                curve: Curves.decelerate
                          ...
                          child: Text(
                            ...
                            "Result" : "Next",
                            style: TextStyle(
                                color: index+1 == dataModel!.level7!.length ?
