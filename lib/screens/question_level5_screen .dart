...
class QuestionLevel5Screen extends StatefulWidget {

  @override
  State<QuestionLevel5Screen> createState() => _QuestionLevel5ScreenState();
}

class _QuestionLevel5ScreenState extends State<QuestionLevel5Screen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: PageView.builder(
          ...
          itemCount: dataModel!.level5!.length,
            ...
            return Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(dataModel!.level5![index].question!,style: TextStyle(color: Colors.white,fontSize: 18),),
                  SizedBox(
                    height: 10,
                  ),
                  Container(
                    ...
                    child: dataModel!.level5![index].img,
                  ),
                  SizedBox(
                    height: 10,
                  ),
                    ...
                    ElevatedButton(
                      style: ElevatedButton.styleFrom(
                          ...
                          shape: RoundedRectangleBorder(
                              ...
                              side: BorderSide(
                                  color: isPressed?
                                  dataModel!.level5![index].answer![i] ? isTrue : isWrong : backGroundColor,
                                  width:2,
                      ...
                      onPressed: () {
                        if(dataModel!.level5![index].answer![i]  && isPressed == false){
                          setState(() {
                            score+=10;
                          });
                        }
                      ...
                      child:Row(
                        children: [
                          ...
                          Text(dataModel!.level5![index].choise![i],style: TextStyle(color:Colors.white)),
                        ],
                      ),
                    ),
                  Row(
                    ...
                    children: [
                      ...
                      ElevatedButton(
                          style: ElevatedButton.styleFrom(
                              ...
                              backgroundColor:
                              index+1 == dataModel!.level5!.length ?
                          ...
                          onPressed: () {
                            ...
                            Navigator.push(
                              context,
                              MaterialPageRoute(builder: (context)=>ResultScreen(finalScore: score,level: "level5",)),
                            ):
                            controller!.nextPage(
                                duration: Duration(seconds: 1),
                                curve: Curves.decelerate
